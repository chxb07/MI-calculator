document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculateSemesterAverage() {
        ...
        if (totalCoef > 0) {
            ...
            localStorage.setItem('semester1-average', semesterAverage.toFixed(2));
            localStorage.setItem('semester1-credits', totalCred);
        } else {
            moyenneCol.textContent = '0';
            credModCol.textContent = '0';
        }
    ...
    function loadSavedData() {
        const savedData = localStorage.getItem('semester1-data');
        if (savedData) {
            try {
